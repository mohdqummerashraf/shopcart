...
export const Login = () => {
  ...
  return (
    <Stack width="90vw" height="100vh" flexDirection="row" sx={{ overflow: "hidden" }}>
      ...
      <Stack flex={1} justifyContent="center" alignItems="center">
        ...
        <Stack mt={4} spacing={2} width={is480 ? "90vw" : '28rem'} maxWidth="90vw" component="form" noValidate onSubmit={handleSubmit(handleLogin)}>
