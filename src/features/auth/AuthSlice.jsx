...
import { checkAuth, createUser, forgotPassword, login, logout, resendOtp, resetPassword, signup, verifyOtp } from './AuthApi'
...
export const createUserAsync=createAsyncThunk('auth/createUserAsync',async(cred)=>{
    const res=await createUser(cred)
    return res
})
...
export const selectCreatedStatus=(state)=>state.AuthSlice.createdStatus
